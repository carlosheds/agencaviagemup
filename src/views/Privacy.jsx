...
export default function Privacy() {
    return (
        <div className="container">
            ...
            <p>A sua privacidade é importante para nós. É política do site Agência de Viagens Up respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no site <a href='#'>Agência de Viagens Up</a>, e outros sites que possuímos e operamos.</p>
            ...
            <p>Trabalhamos com base na Lei de Proteção de Dados (13.709/2018) que traz garantias de privacidade, confidencialidade, retenção, proteção aos direitos fundamentais de liberdade e  o livre desenvolvimento da personalidade da pessoa. Além disso, respeitamos a Constituição Federal da República Federativa do Brasil, o Código de Defesa do Consumidor (Lei 8.078/90), Marco Civil da Internet (Lei 12.965/14).</p>
                ...
                <p>O uso continuado de nosso site será considerado como aceitação de nossas práticas em torno de privacidade e informações pessoais. Se você tiver alguma dúvida sobre como lidamos com dados do usuário e informações pessoais, entre em contato conosco através do e-mail contato@agenciadeviagensup.com.</p>

                <p>Nossa política é atualizada de forma constante.</p>

                <p>Fica, desde já, o titular de dados ciente que o conteúdo desta Política de Privacidade pode ser alterado a critério do site Agência de Viagens Up, independente de aviso ou notificação.  Em caso de alteração, as modificações produzem todos os efeitos a partir do momento da disponibilização no site. </p>

                <p>O site Agência de Viagens Up não se responsabiliza caso você venha utilizar seus dados de forma incorreta ou inverídica, ficando excluído de qualquer responsabilidade neste sentido.</p>
                ...
                <p>O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o site Agência de Viagens Up oferece e com caráter enunciativo, mas não limitativo:</p>
                ...
                <p>O titular de dados pessoais possui o direito de solicitar do site Agência de Viagens Up, através do canal específico de tratamento, a qualquer momento, mediante requisição formal, informações referentes aos seus dados.</p>
                ...
                <ul>
                    ...
                    <li>Para as demais solicitações em relação aos direitos do titular de dados pessoais, entre em contato conosco através do e-mail contato@agenciadeviagensup.com;</li>
                </ul>
